  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={handleSwitchDarkMode}>
          <FontAwesomeIcon icon={darkMode ? faSun : faMoon} color={darkMode ? '#FFA500' : undefined}/>
        </button>
